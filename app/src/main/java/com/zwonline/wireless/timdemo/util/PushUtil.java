package com.zwonline.wireless.timdemo.util;
...
import com.zwonline.wireless.timdemo.HomeActivity;
import com.zwonline.wireless.timdemo.R;
import com.zwonline.wireless.timdemo.TIMApplication;
import com.zwonline.wireless.timdemo.event.MessageEvent;
import com.zwonline.wireless.timdemo.model.CustomMessage;
import com.zwonline.wireless.timdemo.model.Message;
import com.zwonline.wireless.timdemo.model.MessageFactory;
...
public class PushUtil implements Observer {
    ...
    private void PushNotify(TIMMessage msg) {
        ...
        NotificationManager mNotificationManager = (NotificationManager) TIMApplication.getContext().getSystemService
                (TIMApplication.getContext().NOTIFICATION_SERVICE);
...
//                .setNumber(++pushNum) //设置通知集合的数量
    ...
    public void reset() {
        NotificationManager notificationManager = (NotificationManager) TIMApplication.getContext().getSystemService
                (TIMApplication.getContext().NOTIFICATION_SERVICE);
